...
<head>
    ...
    <title>{{ $colocation->nom ?? 'Colocation' }} | EasyColoc</title>
...
<body class="flex min-h-screen text-slate-700 text-sm">
    ...
    <main class="flex-1 ml-60 p-6">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-2xl font-bold">{{ $colocation->nom ?? 'Aucune colocation' }}</h2>
            ...
            <div class="flex items-center gap-3">
                ...
                @else
                    ...
                    <a href="{{ route('colocations.create') }}"
                        class="px-4 py-2 bg-indigo-600 text-white rounded-lg text-xs font-bold flex items-center gap-2 hover:bg-indigo-700">
                        <i class="fa-solid fa-house"></i> Créer Colocation
                    </a>
                @endif
                ...
                <div class="flex items-center space-x-2 border-l border-gray-200 pl-4">
                    ...
                    <div
                        class="w-8 h-8 rounded-full bg-indigo-100 flex items-center justify-center font-bold text-indigo-600 text-sm">
        ...
        @if ($colocation)
            <div class="grid grid-cols-3 gap-5 mb-6">
                <div class="bg-white p-4 rounded-xl shadow-sm flex items-center gap-3">
                    <div
                        class="w-10 h-10 bg-indigo-50 text-indigo-600 flex items-center justify-center rounded-lg text-lg">
                ...
                <div class="bg-white p-4 rounded-xl shadow-sm flex items-center gap-3">
                    <div
                        class="w-10 h-10 bg-green-50 text-green-600 flex items-center justify-center rounded-lg text-lg">
                ...
                <div class="bg-white p-4 rounded-xl shadow-sm flex items-center gap-3">
                    <div
                        class="w-10 h-10 bg-yellow-50 text-yellow-600 flex items-center justify-center rounded-lg text-lg">
            ...
            <div class="bg-white p-5 rounded-xl shadow-sm mb-6">
                <h3 class="font-bold mb-3 flex items-center gap-2"><i class="fa-solid fa-receipt text-indigo-600"></i>
                    Dépenses récentes</h3>
                <table class="w-full text-xs">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="py-6 text-center text-gray-400 italic">Aucune dépense.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
            ...
            <div class="bg-white p-5 rounded-xl shadow-sm">
                <h3 class="font-bold mb-3 flex items-center gap-2"><i class="fa-solid fa-users text-indigo-600"></i>
                    Membres</h3>
                <div class="space-y-2">
                    @forelse ($colocation->memberships as $m)
                        <div
                            class="flex justify-between items-center p-2 border rounded-lg hover:bg-gray-50 transition">
                            <div class="flex items-center gap-3">
                                <div
                                    class="w-8 h-8 rounded-full bg-indigo-50 flex items-center justify-center font-bold text-indigo-600">
                            ...
                            <span
                                class="text-xs font-bold {{ $m->role === 'owner' ? 'text-yellow-500' : 'text-gray-400' }}">
    ...
    <div id="modal-depense"
        ...
        <div class="bg-white rounded-xl shadow-lg w-full max-w-md p-6 relative">
            ...
            @else
                ...
                <a href="{{ route('colocations.create') }}">Créer Colocation</a>
            @endif
        </div>
    </div>
